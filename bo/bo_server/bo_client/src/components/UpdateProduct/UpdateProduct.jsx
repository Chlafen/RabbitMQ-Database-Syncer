...
const UpdateProduct = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if(!product.id || 
      (!product.product && !product.date && !product.region && !product.qty && !product.cost && !product.amount && !product.tax && !product.total)) {
  ...
  return (
    <div className='add-product'> 
      ...
      <form>
        ...
        <input type="text" name="id" onChange={(e) => setProduct({...product, id: e.target.value})} />
